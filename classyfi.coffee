...
latin = fs.readFileSync 'latin.txt'
english = fs.readFileSync 'english.txt'
...
latinTest = fs.readFileSync 'latin_test.txt'
englishTest = fs.readFileSync 'english_test.txt'
